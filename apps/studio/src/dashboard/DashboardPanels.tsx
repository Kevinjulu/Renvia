...
export function DashboardPanels({ onCreate }: { onCreate: () => void }) {
  return <aside className="dashboard-panels">
    <section className="dashboard-panel plan-panel"><div className="panel-heading"><h3>Your plan</h3><span>Free</span></div><p><b>0 / 10</b> renders used</p><div className="plan-progress"><i/><small>0%</small></div><button type="button">Upgrade plan <span>→</span></button></section>
    <section className="dashboard-panel quick-panel"><h3>Quick actions</h3><button type="button" onClick={onCreate}><span className="quick-dark">＋</span>New project</button><button type="button"><span><Icon><path d="M4 10 12 4l8 6v9H4Z"/><path d="M12 8v7m-3-3 3 3 3-3"/></Icon></span>Upload file</button><button type="button"><span><Icon><rect x="4" y="4" width="6" height="6"/><rect x="14" y="4" width="6" height="6"/><rect x="4" y="14" width="6" height="6"/><rect x="14" y="14" width="6" height="6"/></Icon></span>Browse templates</button><button type="button"><span><Icon><circle cx="9" cy="8" r="3"/><path d="M3 20a6 6 0 0 1 12 0M17 6a3 3 0 0 1 0 6M17 15a5 5 0 0 1 4 5"/></Icon></span>Invite team</button></section>
    <section className="dashboard-panel activity-panel"><div className="panel-heading"><h3>Recent activity</h3><button type="button">View all →</button></div><Activity icon="✎" title="You edited Project (2)" time="5 days ago"/><Activity icon="▧" title="Render completed" detail="Lakeside Villa" time="1 week ago"/><Activity icon="＋" title="You created a new project" detail="Modern Residence" time="1 week ago"/><Activity icon="⇧" title="File uploaded" detail="Apartment Interior" time="2 weeks ago"/></section>
