...
export const GUIDE_TOPICS: Record<GuideTopicId, GuideTopic> = {
  "control.uploads": {
    ...
    body: "Each slot is one elevation of the same building. Upload only the sides you have. Generate renders every filled elevation and ignores empty ones.",
    how: "Click a slot to upload, or drop a PNG, JPEG, or WebP. Extra views such as a roof or isometric sit under Add elevation.",
